...
class QuillEditor extends React.Component {
    ...
    render() {
        return (
            <div >
                <div id="toolbar" style={{backgroundColor:"white"}}>
                    <select className="ql-header" style={{color:"black"}} defaultValue={""} onChange={e => e.persist()}>
                    ...
                    <button className="ql-insertImage"  style={{color:"black"}}>
                        I
                    </button>
                    <button className="ql-insertVideo" style={{color:"black"}}>
                        V
                    </button>
                    <button className="ql-insertFile" style={{color:"black"}}>
                        F
                    </button>
      ...
      <option selected />
                ...
                <div style={{backgroundColor:"white",height:"500px",overflowY:"scroll"}}>
                <ReactQuill
