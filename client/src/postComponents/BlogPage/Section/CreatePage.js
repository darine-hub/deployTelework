...
function CreatePage() {
    ...
    return (
        ...
        <div className="main-container" >
            <BarreNavigationHome/>
            <div className="container middle-container block" style={{ width: '65%',padding:"20px 70px" ,height:"auto"}}>
            <div style={{ textAlign: 'center',padding:"0 20px 20px 20px" }} className="titular">
                <h1 > Editor</h1>
            </div>
            
            <input placeholder="write description..." style={{backgroundColor:"white",width:"100%",marginBottom:"15px"}} onChange={e=>setDescription(e.target.value)}/>
            <QuillEditor
